...
function verifyAuth(req) {
  ...
  if (!expectedToken) {
    throw new Error('CLEANUP_AUTH_TOKEN not configured');
  }
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('Iniciando limpieza automática de storage...');
    ...
    return res.status(200).json({
      success: true,
      message: `Limpieza completada. ${totalDeleted} archivos eliminados.`,
      ...summary
    });
